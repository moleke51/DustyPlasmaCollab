...
plt.xlabel('Normalsied radius (Log scale)')
plt.xscale('log')
plt.grid()
plt.legend()
...
Phi__OML2 = OML_surface_potential_finder(Theta__OML,271,z)
Phi__OML3 = OML_surface_potential_finder(Theta__OML,85.4,z)
...
plt.plot(Theta__OML, Phi__OML2, label = 'Argon')
plt.plot(Theta__OML, Phi__OML3, label = 'Helium')
plt.title('Dust surface potential variation with Theta - OML')
plt.ylabel('Normalised surface potential')
plt.xlabel('Ion temperature/electron temperature (Log scale)')
plt.legend()
plt.xscale('log')
plt.grid()
...
plt.plot(Theta__SOML, Phi__SMOML1, label = 'u = 1')
plt.plot(Theta__SOML, Phi__SMOML2, label = 'u = 2')
plt.plot(Theta__SOML, Phi__SMOML4, label = 'u = 4')
